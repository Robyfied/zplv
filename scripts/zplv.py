...
####
#### CA SA MODIFICI PENTRU ANUL URMATOR SCHIMBA LINIILE 39, 40, 43 SI 56
####
...
class ProgressBar:
    def school_days(self, _date: dt.date):
        ...
        school_days = 0
        i = 0
        while i < 270:   # 270 = days from first day of school to last day of school
            school_days += 1
    ...
    def progress_bar(self, _date: dt.date):
        ...
        return perc
        #TODO: actual ascii progress bar ▰▰▰▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱ (increases every 5%)
